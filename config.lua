...
Config.webhook = "https://discord.com/api/webhooks/840587740923035679/Nskhh-BX4s0oCoyZj3vRky9yA4mGtWCJ3hNfEUksKls6ouXZW-ds97ADLVffgYkBWj-4"						-- Webhook to send logs to discord
...
Config.format = {
	...
	['location'] = 'fr-EU'						-- This is the location of your country, to format the decimal places according to your standard [Examples: pt-BR, en-US]
}
...
Config.gas_station_locations = {
	["gas_station_1"] = {										-- ID
		['buy_price'] = 90000,									-- Price to buy this gas station
